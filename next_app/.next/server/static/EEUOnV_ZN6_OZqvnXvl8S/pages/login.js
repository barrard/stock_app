...
var Login_Form_Login_Form =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(Login_Form, _React$Component);

  function Login_Form(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Login_Form);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Login_Form).call(this, props)); // console.log('THS IS LOGIN FORM')
    // console.log(props)
  ...
  Object(createClass["a" /* default */])(Login_Form, [{
    key: "handle_input",
    value: function handle_input(input, type) {
      this.setState(Object(defineProperty["a" /* default */])({}, type, input)); // console.log({ input, type });

      this.props.handle_input(input, type);
    }
  }, {
    key: "handle_login",
    value: function handle_login(e) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        onSubmit: function onSubmit(event) {
          return _this2.handle_login(event);
        }
        ...
        name: "remember_me",
        type: "checkbox"
      }), " ", "Remember me")))), external_react_default.a.createElement("input", {
        type: "hidden",
        name: "_csrf",
        ...
        type: "submit",
        value: "Login"
      })))), external_react_default.a.createElement("p", null, this.props.go), external_react_default.a.createElement("div", {
        className: "col-sm-12 justify_center"
...
/* harmony default export */ var forms_Login_Form = (Login_Form_Login_Form);
...
var login_success = user_actions["b" /* login_success */],
    login_attempt = user_actions["a" /* login_attempt */];
...
function (_React$Component) {
  ...
  function Login(props) {
    ...
    _this.handle_login = _this.handle_login.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.handle_login_resp = _this.handle_login_resp.bind(Object(assertThisInitialized["a" /* default */])(_this));
  ...
  Object(createClass["a" /* default */])(Login, [{
    ...
    key: "handle_login",
    value: function () {
      var _handle_login = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(data) {
        var _csrf, email, password, resp;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                email = data.email, password = data.password; // event.preventDefault();
      ...
      function handle_login(_x) {
        return _handle_login.apply(this, arguments);
      }
    ...
    key: "handle_login_resp",
    value: function () {
      var _handle_login_resp = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                if (json.errors && json.errors.length) {
                  ...
                  this.setState({
                    errors: json.errors.map(function (err) {
                      return err;
                    })
                  });
                  ...
                  external_react_redux_toastr_["toastr"].success("Welcome back ".concat(this.state.email), "You are being logged in as ".concat(this.state.email));
      ...
      function handle_login_resp(_x2) {
        return _handle_login_resp.apply(this, arguments);
      }

      return handle_login_resp;
    }()
  }, {
    key: "render",
    value: function render() {
      ...
      return external_react_default.a.createElement(Main_Layout["a" /* default */], {
      ...
      }, external_react_default.a.createElement("h1", null, "Login"), external_react_default.a.createElement("p", {
        className: "lead mb-1"
      }, "Start Today", external_react_default.a.createElement("br", null)), external_react_default.a.createElement("br", null))), external_react_default.a.createElement("div", {
        className: "row mt-5 justify_center"
      }, external_react_default.a.createElement("div", {
        className: "col-md-6 "
      }, external_react_default.a.createElement(forms_Login_Form, {
        ...
        className: "offset-sm-2 col-sm-8 text-center"
      }, external_react_default.a.createElement("a", {
...
/* harmony default export */ var login = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps)(login_Login));
