...
/******/ 	return __webpack_require__(__webpack_require__.s = "c0fe");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = __webpack_require__("qmvx");
...
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("hDBU");
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("azxR");
...
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("YKN3");
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("tEuJ");
...
/* harmony import */ var react_redux_toastr__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("J5aF");
...
/* harmony import */ var _layouts_Main_Layout_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("4cCf");
...
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(Trade_Posts, _React$Component);

  function Trade_Posts(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(this, Trade_Posts);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(Trade_Posts).call(this, props));
    _this.state = {
      posts: props.posts,
      direction: "",
      symbol: "",
    ...
    _this.handle_view_click = _this.handle_view_click.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(Trade_Posts, [{
    key: "componentDidMount",
    value: function componentDidMount() {}
  }, {
    key: "handle_input",
    value: function handle_input(e, prop) {
      this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])({}, prop, e.target.value));
      console.log({
        prop: prop
      });
    }
  }, {
    key: "handle_view_click",
    value: function handle_view_click(id) {
      console.log({
        id: id
      });
      ...
      var _this$props$posts$fil = this.props.posts.filter(function (post) {
        return post._id == id;
          ...
          _this$props$posts$fil2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(_this$props$posts$fil, 1),
      ...
      var state = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])({}, this.state, post, {
        edit_mode: true,
        edit_id: post._id
      });

      this.setState(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])({}, state));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(_layouts_Main_Layout_js__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Trade_Post_View, {
        diretion: diretion,
        symbol: symbol,
        entry: entry,
        stop: stop,
        ...
        src: "/static/trade_post_imgs/".concat(file_name),
        alt: "",
        id: "chart"
      })))), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
        className: "row flex_center"
        ...
        className: "col-sm-12 "
      }, posts && posts.length > 0 && react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Previous_Posts_List, {
        handle_view_click: function handle_view_click(id) {
          return _this2.handle_view_click(id);
        },
        posts: posts
      }))));
    }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_12__["connect"])(mapStateToProps)(Object(next_router__WEBPACK_IMPORTED_MODULE_14__["withRouter"])(Trade_Posts)));
/* FUNCTIONAL COMPONENTS */

var Previous_Posts_List = function Previous_Posts_List(_ref2) {
  var posts = _ref2.posts,
      _handle_view_click = _ref2.handle_view_click;
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    className: "row "
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    className: "col-sm-12 "
  }, posts.map(function (post, index) {
    return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Trade_Post, {
      key: index,
      index: index,
      post: post,
      handle_view_click: function handle_view_click(id) {
        return _handle_view_click(id);
      }
    });
  })));
};
...
var Trade_Post = function Trade_Post(_ref3) {
  var post = _ref3.post,
      index = _ref3.index,
      handle_view_click = _ref3.handle_view_click,
  ...
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    ...
    className: "col-sm-2 flex_center"
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Symbol, {
    symbol: post.symbol
  })), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    className: "col-sm-2 flex_center"
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(View_Btn, {
    handle_click: function handle_click(e) {
      return handle_view_click(post._id);
    }
  })));
};

var View_Btn = function View_Btn(_ref4) {
...
var Symbol = function Symbol(_ref5) {
...
var Direction_Selection = function Direction_Selection(_ref6) {
  var val = _ref6.val;
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    className: "form-group"
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("label", {
    htmlFor: "trade direction"
  }, "Trade Direction"), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("select", {
    value: val,
    className: "form-control opaque"
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("option", {
    value: "long"
  }, "Long"), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("option", {
    value: "short"
  }, "Short")));
};

var Certainty_Selection = function Certainty_Selection(_ref7) {
  var val = _ref7.val;
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    className: "form-group"
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("label", null, "Level Of Certainty"), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("p", null, val));
};

var Trade_Notes = function Trade_Notes(_ref8) {
  var val = _ref8.val;
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    className: "form-group"
  }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("label", {
    htmlFor: "Notes"
  }, "Notes"), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("textarea", {
    value: val,
    className: "form-control opaque",
    rows: "3"
  }));
...
var Trade_Post_View = function Trade_Post_View(_ref9) {
  var submit_new_post = _ref9.submit_new_post,
      symbol = _ref9.symbol,
      diretion = _ref9.diretion,
      img = _ref9.img,
      entry = _ref9.entry,
      stop = _ref9.stop,
      first_target = _ref9.first_target,
      second_target = _ref9.second_target,
      certainty = _ref9.certainty,
      notes = _ref9.notes,
      edit_mode = _ref9.edit_mode,
      edit_id = _ref9.edit_id;
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("form", null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Input, {
    val: symbol,
    label: "Symbol",
    prop: "symbol"
    ...
    label: "Second Target",
    prop: "second_target"
  }), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Direction_Selection, {
    val: diretion
  }), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Certainty_Selection, {
    val: certainty
  }), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Trade_Notes, {
    val: notes
...
var Input = function Input(_ref10) {
  var val = _ref10.val,
      label = _ref10.label,
      prop = _ref10.prop;
  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
    ...
    htmlFor: "symbol"
  }, label), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("input", {
    value: val,
    type: "text",
    className: "form-control opaque",
    placeholder: label
