...
// CONCATENATED MODULE: ./redux/reducers/meta_reducer.js
...
/* harmony default export */ var meta_reducer = (function () {
  ...
  switch (action.type) {
    ...
    case "SET_API_SERVER":
      {
        var api_server = action.api_server,
            iex_server = action.iex_server;
        return Object(objectSpread["a" /* default */])({}, state, {
...
// CONCATENATED MODULE: ./redux/reducers/user_reducer.js

// import * as meta_actions from "../actions/meta_actions.js";
var user_reducer_initial_state = {
  user: {},
  username: "",
  password: "",
  is_loggedin: false
...
/* harmony default export */ var user_reducer = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : user_reducer_initial_state;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
// CONCATENATED MODULE: ./redux/reducers/stock_data_reducer.js


// import * as meta_actions from "../actions/meta_actions.js";
var stock_data_reducer_initial_state = {
...
/* harmony default export */ var stock_data_reducer = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : stock_data_reducer_initial_state;
  var action = arguments.length > 1 ? arguments[1] : undefined;
  ...
  switch (action.type) {
    case "SET_SECTOR_DATA":
      {
        ...
        var sector_data = Object(objectSpread["a" /* default */])({}, state.sector_data, Object(defineProperty["a" /* default */])({}, sector, data));
    ...
    case "SET_HOME_PAGE_DATA":
      {
        var home_page_data = action.home_page_data,
            home_page_data_set_at = action.home_page_data_set_at;
        return Object(objectSpread["a" /* default */])({}, state, {
    ...
    case "ADD_CHART_DATA":
      {
        var charts = Object(objectSpread["a" /* default */])({}, state.charts, action.chart_data);
...
// CONCATENATED MODULE: ./redux/reducers/MA_analysis_reducer.js
...
// import * as meta_actions from "../actions/meta_actions.js";
var MA_analysis_reducer_initial_state = (_initial_state = {
  queries: [{
    MA: "50",
    g_l: "g",
    perc: 20
  ...
  saved_query_results: [],
  saved_queries: []
}, Object(defineProperty["a" /* default */])(_initial_state, "saved_query_results", []), Object(defineProperty["a" /* default */])(_initial_state, "current_query_results", []), Object(defineProperty["a" /* default */])(_initial_state, "sorted_query_results", []), Object(defineProperty["a" /* default */])(_initial_state, "number_rows", 30), Object(defineProperty["a" /* default */])(_initial_state, "sorted_prop", "volume"), Object(defineProperty["a" /* default */])(_initial_state, "sort_state", false), _initial_state);
/* harmony default export */ var MA_analysis_reducer = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : MA_analysis_reducer_initial_state;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
/* harmony default export */ var reducers = (Object(external_redux_["combineReducers"])({
  ...
  MA_analysis: MA_analysis_reducer
}));
...
var reduxDevtools = typeof window !== "undefined" && "production" !== "production" ? window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__() : function (f) {
  return f;
};
var enhancers = Object(external_redux_["compose"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a), reduxDevtools);
var store_makeStore = function makeStore(initialState) {
  return Object(external_redux_["createStore"])(reducers, initialState, enhancers);
};
...
// CONCATENATED MODULE: ./components/small_components/loading_bar.js


/* NProgress bar setup */

router_default.a.events.on('routeChangeStart', function (url) {
  ...
  Object(createClass["a" /* default */])(MyApp, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(app["Container"], null, external_react_default.a.createElement(external_react_redux_["Provider"], {
        store: store
      }, external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_react_redux_toastr_default.a, {
        timeOut: 4000,
        newestOnTop: false,
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee(_ref) {
        var Component, ctx, _csrf, api_server, pageProps;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (ctx.isServer) {
                  ...
                  ctx.store.dispatch(Object(meta_actions["b" /* set_api_server */])(api_server));
                  ctx.store.dispatch(Object(meta_actions["c" /* set_csrf */])(_csrf));
                  if (ctx.req.user) ctx.store.dispatch(Object(user_actions["e" /* set_user */])(ctx.req.user));
                }
