...
/******/ 	return __webpack_require__(__webpack_require__.s = "101c");
/******/ })
/************************************************************************/
/******/ ({
...
// EXTERNAL MODULE: ./redux/actions/user_actions.js
var user_actions = __webpack_require__("eKws");

// EXTERNAL MODULE: ./components/forms/Social_Buttons.js
var Social_Buttons = __webpack_require__("mShl");

// EXTERNAL MODULE: external "isomorphic-fetch"
var external_isomorphic_fetch_ = __webpack_require__("W+0S");

// CONCATENATED MODULE: ./components/forms/Signup_Form.js
...
var Signup_Form_Signup_Form =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(Signup_Form, _React$Component);

  function Signup_Form(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Signup_Form);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Signup_Form).call(this, props)); // console.log('THS IS Signup FORM')
    // console.log(props)
  ...
  Object(createClass["a" /* default */])(Signup_Form, [{
    key: "handle_input",
    value: function handle_input(input, type) {
      this.setState(Object(defineProperty["a" /* default */])({}, type, input));
      this.props.handle_input(input, type); // console.log({ input, type });
    }
  }, {
    key: "handle_signup",
    value: function handle_signup(event) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        onSubmit: function onSubmit(event) {
          return _this2.handle_signup(event);
        }
        ...
        onChange: function onChange(event) {
          return _this2.handle_input(event.target.value, "email");
        },
        ...
        onChange: function onChange(event) {
          return _this2.handle_input(event.target.value, "password");
        },
        className: "form-control",
        name: "password",
        type: "password",
        ...
        onChange: function onChange(event) {
          return _this2.handle_input(event.target.value, "confirm_password");
        },
        className: "form-control",
      ...
      }, external_react_default.a.createElement("h3", null, "Other login options")), external_react_default.a.createElement(Social_Buttons["a" /* default */], null));
    }
  }]);
...
/* harmony default export */ var forms_Signup_Form = (Signup_Form_Signup_Form);
// EXTERNAL MODULE: ./layouts/Main_Layout.js + 7 modules
...
var register_success = user_actions["d" /* register_success */],
    register_attempt = user_actions["c" /* register_attempt */],
    set_user = user_actions["e" /* set_user */];

var sign_up_Signup =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(Signup, _React$Component);

  function Signup(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, Signup);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Signup).call(this, props));
    _this.state = {
      errors: [],
      email: "",
      password: "",
    ...
    _this.handle_signup = _this.handle_signup.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.handle_signup_resp = _this.handle_signup_resp.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.handle_input = _this.handle_input.bind(Object(assertThisInitialized["a" /* default */])(_this));
    return _this;
  }

  Object(createClass["a" /* default */])(Signup, [{
    key: "componentDidMount",
    value: function componentDidMount() {}
    /* Get form input */
    ...
    key: "handle_input",
    value: function handle_input(input, type) {
      this.setState(Object(defineProperty["a" /* default */])({}, type, input)); // this.props.handle_input(input, type)
    ...
    key: "handle_signup",
    value: function () {
      var _handle_signup = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(data) {
        var _csrf, email, password, confirm_password, resp;
      ...
      function handle_signup(_x) {
        return _handle_signup.apply(this, arguments);
      }
    ...
    key: "handle_signup_resp",
    value: function () {
      var _handle_signup_resp = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee2(resp) {
        var json;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                if (json.errors && json.errors.length) {
                  ...
                  json.errors.map(function (err) {
                    external_react_redux_toastr_["toastr"].error('Error Message', "".concat(err.msg));
                  }); // this.setState({
                  ...
                  external_react_redux_toastr_["toastr"].success('New User', "You are being logged in as ".concat(this.state.email));
                  router_default.a.push('/account-profile');
                }
              ...
              case 7:
                ...
                console.log('err');
                console.log(_context2.t0); //this means login failed

                external_react_redux_toastr_["toastr"].error('Error....');
      ...
      function handle_signup_resp(_x2) {
        return _handle_signup_resp.apply(this, arguments);
      }

      return handle_signup_resp;
    }()
  }, {
    key: "render",
    value: function render() {
      // console.log(this.props)
      return external_react_default.a.createElement(Main_Layout["a" /* default */], {
        className: "container"
      }, external_react_default.a.createElement("div", {
        className: ""
      ...
      }, external_react_default.a.createElement("br", null), external_react_default.a.createElement("h1", null, "Signup"), external_react_default.a.createElement("p", {
        className: "lead mb-1"
      }, "Strat today!", external_react_default.a.createElement("br", null), "Share with friends!"))), external_react_default.a.createElement("div", {
        className: "row mt-5 text-center"
      }, external_react_default.a.createElement("div", {
        className: "col-md-10  offset-md-1"
      }, external_react_default.a.createElement(forms_Signup_Form, {
        ...
        className: "action"
      }, "Try us - ", external_react_default.a.createElement("b", {
        className: "embolden"
      }, "it's free"), ".")))))));
    }
  }], [{
        ...
        return regenerator_default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                Object(auth["b" /* ensure_not_loggedin */])(ctx);
...
/* harmony default export */ var sign_up = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps)(sign_up_Signup));
...
"use strict";
/* unused harmony export LOGIN_ATTEMPT */
/* unused harmony export LOGIN_ATTEMPT_SUCCESS */
/* unused harmony export LOGIN_ATTEMPT_FAIL */
/* unused harmony export REGISTER_ATTEMPT */
/* unused harmony export REGISTER_ATTEMPT_SUCCESS */
/* unused harmony export REGISTER_ATTEMPT_FAIL */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return set_user; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return register_attempt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return register_success; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return login_attempt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return login_success; });
/* harmony import */ var _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("XzKa");
...
var LOGIN_ATTEMPT = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('LOGIN_ATTEMPT');
var LOGIN_ATTEMPT_SUCCESS = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('LOGIN_ATTEMPT_SUCCESS');
var LOGIN_ATTEMPT_FAIL = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('LOGIN_ATTEMPT_FAIL');
var REGISTER_ATTEMPT = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('REGISTER_ATTEMPT');
var REGISTER_ATTEMPT_SUCCESS = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('REGISTER_ATTEMPT_SUCCESS');
var REGISTER_ATTEMPT_FAIL = _babel_runtime_corejs2_core_js_symbol__WEBPACK_IMPORTED_MODULE_0___default()('REGISTER_ATTEMPT_FAIL');
...
function register_attempt(user) {
...
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(Social_Buttons, _React$Component);

  function Social_Buttons(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, Social_Buttons);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Social_Buttons).call(this, props));
    _this.state = {};
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(Social_Buttons, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
        className: "col-sm-12"
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
        className: "row justify_center"
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("a", {
        href: "/auth/facebook",
        className: "sc-btn sc--flat sc--facebook"
      ...
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("g", null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("path", {
        ...
        className: "sc-text"
      }, "Sign in with Facebook")), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("a", {
        href: "/auth/google",
        className: "sc-btn sc--flat sc--google-plus"
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("span", {
        className: "sc-icon"
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("svg", {
        viewBox: "0 0 33 33",
...
/* harmony default export */ __webpack_exports__["a"] = (Social_Buttons);
