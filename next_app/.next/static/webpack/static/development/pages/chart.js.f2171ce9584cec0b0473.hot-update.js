...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Canvas_Chart, [{
    ...
    value: function draw_cross_hair(e) {
      ...
      var canvas = crosshair_overlay; // let vol_canvas = Main_data.canvas_data[0].volume_canvas_overlay
      // console.log({x, y})

      var price_label = _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_0___default()(min_price + (canvas.height - top) * pennies_per_pixel / 100).toFixed(3); // console.log(price_label)
      // console.log({x, y})
      ...
      x_hair_ctx.stroke();
      this.write_label(price_label, "white", 14, x_hair_ctx, x, y);
    }
  }, {
    key: "draw_chart",
    ...
    value: function draw_price_markers(context, min, max) {
      ...
      for (var _x = 0; _x < chart_height; _x++) {
        if (_x % price_marker_position == 0) {
          context.beginPath();
          context.moveTo(0, chart_height - _x);
          context.lineTo(canvas.width, chart_height - _x);
          context.stroke();
          ...
          write_label(price_label, "red", 10, context, canvas.width - text.width * 2, chart_height - _x);
          marker_count++;
        }
      }
    }
...
//# sourceMappingURL=chart.js.f2171ce9584cec0b0473.hot-update.js.map