...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Canvas_Chart, [{
    ...
    value: function draw_cross_hair(e) {
      var x = e.layerX;
      var y = e.layerY; // console.log({ x, y })

      var canvas = Main_data.canvas_data[0].crosshair_overlay; // let vol_canvas = Main_data.canvas_data[0].volume_canvas_overlay

      var min_max = Main_data.canvas_data[0].min_max;
      var pennies_per_pixel = Main_data.canvas_data[0].pennies_per_pixel; // console.log({x, y})

      var price_label = _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_0___default()(min_max.min + (canvas.height - y) * pennies_per_pixel / 100).toFixed(3); // console.log(price_label)
      // console.log({x, y})


      var x_hair_ctx = canvas.getContext("2d"); // let x_hair_vol_ctx = vol_canvas.getContext('2d')

      x_hair_ctx.clearRect(0, 0, canvas.width, canvas.height);
      vol_ctx.clearRect(0, 0, volume_canvas_overlay.width, volume_canvas_overlay.height); //horizontal crosshair line on chart
      ...
      x_hair_ctx.stroke(); //vertical crosshairline on volume
...
//# sourceMappingURL=chart.js.87c03615daf88272412c.hot-update.js.map