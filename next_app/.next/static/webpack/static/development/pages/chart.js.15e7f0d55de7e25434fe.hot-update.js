...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Canvas_Chart, [{
    ...
    value: function run_spinner() {
      ...
      var spinner_timmer = setInterval(draw, 1000 / 30);
      this.setState({
    ...
    value: function draw_chart(canvas_background_color) {
      ...
      console.log("Candle width = ".concat(this.state.candle_width));
      var volume_canvas_height = canvas.height * 0.2; //volume will be lower 20% (should be adjustable)

      var chart_height = canvas.height * 0.8;
    ...
    key: "draw_candle",
    value: function draw_candle(position, data, width, ppp, ppv) {}
  }, {
    key: "draw_MA",
    value: function draw_MA(data, color, context) {
      ...
      var _this$state = this.state,
          ...
          number_of_pennies = _this$state.number_of_pennies,
          pennies_per_pixel = _this$state.pennies_per_pixel,
          pixels_per_penny = _this$state.pixels_per_penny,
          pixels_per_vol = _this$state.pixels_per_vol,
      ...
      new_data.forEach(function (d, count) {
        ...
        console.log({
          ...
          prev_candle_position: prev_candle_position
        });
        context.beginPath();
        ...
        context.lineTo(line_to_x, line_to_y); // console.log({d, min_max})
        // console.log((max_price - d))
        // console.log((max_price - d) * 100 * pixels_per_penny)
    ...
    value: function render() {
      var _this$state2 = this.state,
          canvas_width = _this$state2.canvas_width,
          canvas_height = _this$state2.canvas_height;
...
//# sourceMappingURL=chart.js.15e7f0d55de7e25434fe.hot-update.js.map