  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Canvas_Chart, [{
    ...
    value: function draw_chart(canvas_background_color) {
      ...
      chart_data.forEach(function (data, count) {
        ...
        draw_candle(context, candle_position, data, candle_width, pixels_per_penny, pixels_per_vol);
      });
    }
  }, {
    ...
    value: function draw_volume(candle_position, max_vol, data, candle_width, ctx, pixels_per_vol) {
      // ctx.fillStyle = color;
      ctx.fillRect(candle_position, (max_vol - data.volume) * pixels_per_vol, candle_width, data.volume * pixels_per_vol);
    }
  }, {
    key: "get_min_price",
    ...
    value: function draw_candle(context, candle_position, candle_data, candle_width, pixels_per_penny, pixels_per_vol) {
      ...
      context.fillRect(candle_position, (min_max.max - candle_data.open) * 100 * pixels_per_penny, candle_width, candle_height); //open line
...
//# sourceMappingURL=chart.js.73e285ca7537b0dac08b.hot-update.js.map